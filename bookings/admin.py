...
class BookingAdmin(admin.ModelAdmin):
    list_display = [
        "property", "tenant", "tenant_first_name", "tenant_last_name",
        "owner_first_name", "owner_last_name", "start_date", "end_date",
        "status", "price_frozen", "created_at",
    ]
    ...
    @admin.display(description=_("Owner first name"), ordering="property__owner__first_name")
    def owner_first_name(self, obj) -> str:
        return obj.property.owner.first_name

    @admin.display(description=_("Owner last name"), ordering="property__owner__last_name")
